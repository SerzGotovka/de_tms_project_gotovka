...
with DAG(
    ...
    tags=["generate", "save_csv_to_minio"],
    description="Даг для генерации данных пользователей, групп, социальных связей, медиа и контента. Сохраняет все данные в CSV файлы в MinIO",
...
# 
        ...
        # Зависимости для социальных связей
        gen_friends_task >> gen_close_friends_task
        
        # gen_social_data должна выполняться ПОСЛЕ всех социальных задач
        [
            gen_friends_task,
            gen_followers_task,
            gen_subscriptions_task,
